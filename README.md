...
# Booking.com - Web - Lesson 2 - Exercise - Javascript
...
```sh
git clone https://github.com/Manual-To-Automation-Booking-Amsterdam/Web-Lesson-2-Exercise-JS.git
```

Move into the directory:

```sh
cd Web-Lesson-2-Exercise-JS
```
